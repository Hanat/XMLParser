...
public class MainActivity extends ActionBarActivity {
  ...
  public void getAdapter() {
    ...
    new AsyncTask<String, Integer, InputStreamReader>() {
      @Override
      protected InputStreamReader doInBackground(String... url) {
        try {
          return new InputStreamReader(getUrlData(url[0]));
      ...
      protected void onPostExecute(InputStreamReader result) {
        ...
        ecbList.setAdapter(new ArrayAdapter<String>(MainActivity.this, android.R.layout.simple_list_item_1, list));
      }
